          ...
          <article>
            <ul class="search-filter">
              ...
              <li class="search-contents">
                ...
                <input type="search" placeholder="폴더명을 입력해주세요." />
          ...
          <article>
            <ul class="current-bar">
              ...
              <li>
                ...
                <router-link
                  to="/allProject/project_labeling/foldermanage"
          ...
          <article class="basic-article">
            <table class="table1">
              ...
              <tr v-for="(item, index) in DatasetListItem" :key="index">
                <td>
                  <router-link to="/allProject/project_labeling/filelist">{{
                    item.datasetName
                  }}</router-link>
                </td>
                <td>
  ...
  data: function () {
    return {
      ...
      DatasetListItem: [
        ...
        {
          datasetName: '지하철 탑승구001',
          projectType: '데이터 가공',
          progressCount: '154',
          allCount: 220,
          projectTypeLink: '/project_labeling',
          workingCount: '140',
          inspectionCount: '53',
          completeCount: '38',
        },
        {
          datasetName: '버스정류장001',
          projectType: '데이터 수집',
          progressCount: '34',
          allCount: 200,
          projectTypeLink: '/project_collect',
          workingCount: '127',
          inspectionCount: '51',
          completeCount: '34',
        },
        {
          datasetName: '버스정류장002',
          projectType: '데이터 가공',
          progressCount: '102',
          allCount: 120,
          projectTypeLink: '/project_labeling',
