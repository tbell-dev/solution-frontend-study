        ...
        <section>
          <article>
            <ul class="current-bar">
              ...
              <li class="bar"></li>
              <li>
                <router-link to="/preprocessingstudio" class="btn3-1 btn-set"
                  >STUDIO</router-link
                >
                ...
                <router-link
                  to="/allProject/project_cleaning/filemanage"
                ...
                <td class="align4">
                  <ul class="left align1">
                    <li class="img-wrap">
                      ...
                      <img
                        :src="
                          require(`../../../../assets/images/studio/${item.img}`)
                        "
                        alt=""
                      />
                    </li>
                  ...
                  <div class="right align2">
                    <router-link
                      to="/preprocessingstudio"
                      class="btn3-2 btn-set"
                      >STUDIO</router-link
                    >
                  </div>
                </td>
...
export default {
  ...
  mounted: function () {
    axios.get('./ProjectDatasetFile.json').then(response => {
      console.log(response.data);
      this.ImageDataListItem = response.data;
    });
  },
  data: function () {
    return {
