      ...
      <div class="studio-left">
        <div class="sl-wrap">
          <ul class="tool-list4">
            <li>
              <img
                v-for="(item, index) in ImageDataListItem1"
                :key="index"
            ...
            <li>
              <img
                v-for="(item, index) in ImageDataListItem2"
                :key="index"
                :src="require(`@/assets/images/studio/${item.img}`)"
                alt=""
              />
            ...
            <li>
              <img
                v-for="(item, index) in ImageDataListItem3"
                :key="index"
                :src="require(`@/assets/images/studio/${item.img}`)"
                alt=""
              />
            ...
            <li>
              <img
                v-for="(item, index) in ImageDataListItem4"
                :key="index"
                :src="require(`@/assets/images/studio/${item.img}`)"
                alt=""
              />
            ...
            <li>
              <img
                v-for="(item, index) in ImageDataListItem5"
                :key="index"
                :src="require(`@/assets/images/studio/${item.img}`)"
                alt=""
              />
            ...
            <li>
              <img
                v-for="(item, index) in ImageDataListItem6"
                :key="index"
                :src="require(`@/assets/images/studio/${item.img}`)"
                alt=""
              />
            ...
            <li>
              <img
                v-for="(item, index) in ImageDataListItem7"
                :key="index"
                :src="require(`@/assets/images/studio/${item.img}`)"
                alt=""
              />
            ...
            <li>
              <img
                v-for="(item, index) in ImageDataListItem8"
                :key="index"
                :src="require(`@/assets/images/studio/${item.img}`)"
                alt=""
              />
            ...
            <li>
              <img
                v-for="(item, index) in ImageDataListItem9"
                :key="index"
                :src="require(`@/assets/images/studio/${item.img}`)"
                alt=""
              />
            ...
            <li>
              <img
                v-for="(item, index) in ImageDataListItem10"
                :key="index"
                :src="require(`@/assets/images/studio/${item.img}`)"
                alt=""
              />
            ...
            <li>
              <img
                v-for="(item, index) in ImageDataListItem11"
                :key="index"
                :src="require(`@/assets/images/studio/${item.img}`)"
                alt=""
              />
            ...
            <li>
              <img
                v-for="(item, index) in ImageDataListItem12"
                :key="index"
                :src="require(`@/assets/images/studio/${item.img}`)"
                alt=""
              />
          ...
          <div class="tool-list4-resize"></div>
        </div>
      </div>
      <div class="studio-center">
        <ul class="option-bar3">
          <li>
            <button class="btn2-0">재생</button>
          </li>
          <li>
            <button class="btn3-0">일시중지</button>
          </li>
          <li>
            <button class="btn3-0">정지</button>
          </li>
          <li>
            <button class="btn3-0">자동선택</button>
          </li>
          <li>
            <button class="btn4-0">삭제</button>
          </li>
        </ul>
